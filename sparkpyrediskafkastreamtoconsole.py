...
spark = SparkSession.builder.appName("kafkaRedisSparkStream").getOrCreate()
...
zSetDecodedEntriesStreamingDF=zSetEntriesEncodedStreamingDF.withColumn("encodedCustomer", unbase64(zSetEntriesEncodedStreamingDF.customer).cast("string"))
