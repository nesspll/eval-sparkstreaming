...
kafkaRawEventsDF = kafkaRawEventsDF.selectExpr("cast(key as string) key", "cast(value as string) value")
...
kafkaEventsSchema = StructType([
    StructField("customer", StringType()),
    StructField("score", StringType()),
    StructField("riskDate", DateType())
])
kafkaRawEventsDF.withColumn("value", from_json("value", kafkaEventsSchema))\
    .select(col('value.*'))\
